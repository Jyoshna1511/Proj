...
img= Canvas(root, bg="blue", height=50, width=50)
...
# Heading
w2 = Label(root,text="Disease Predictor using Machine Learning", fg="white", bg="#00DDFF")
...
S1Lb = Label(root, text="Symptom 1:", fg="yellow", bg="#ff0028")
S1Lb.grid(row=7, column=0, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2:", fg="yellow", bg="#ff0028")
S2Lb.grid(row=8, column=0, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3:", fg="yellow", bg="#ff0028")
S3Lb.grid(row=9, column=0, pady=10, sticky=W)

S4Lb = Label(root, text="Symptom 4:", fg="yellow", bg="#ff0028")
S4Lb.grid(row=10, column=0, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5:", fg="yellow", bg="#ff0028")
